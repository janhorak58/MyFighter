...
{
	if (Index < AttackTemplates.Num()) return AttackTemplates[Index].bCanBeDone;
	return false;
}
...
void APlayerCharacter::SetAttackCanBeDoneByIndex(int Index, bool CanBeDone) 
{
	AttackTemplates[Index].bCanBeDone = CanBeDone;
}
